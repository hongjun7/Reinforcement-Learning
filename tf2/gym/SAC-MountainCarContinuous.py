...
from tf2.model.SAC2 import SoftActorCritic, ReplayBuffer
...
if __name__ == '__main__':
    ...
    sac = SoftActorCritic(action_space, writer, learning_rate=learning_rate, gamma=gamma, tau=tau)
    ...
    while True:
        ...
        if (step % 1 == 0) and (global_step > start_steps):
            for epoch in range(epochs):
                ...
                current_states, actions, rewards, next_states, dones = replay.fetch_sample(num_samples=batch_size)
